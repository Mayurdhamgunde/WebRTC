  ...
  return (
    <ThemeProvider theme={isDarkMode ? darkTheme : theme}>
      <Box sx={{ 
            ...
            <List>
              {Object.keys(users).map((user) => (
                <ListItemButton
                  key={user}
                  component="div"
                  disabled={user === userId || isCallInProgress}
                  sx={{ 
                    borderRadius: 2,
                    mb: 1,
                ...
                >
                  <Avatar 
                    sx={{ 
                      mr: 2, 
                      bgcolor: user === userId ? 'primary.main' : 'secondary.main',
                      width: 40,
                      height: 40
                    }}
                  >
        ...
        <Dialog 
          open={notification.type === 'incoming'} 
          onClose={() => rejectCall(notification.user!)}
          PaperProps={{
            sx: {
              borderRadius: 3,
              minWidth: 320,
        ...
        >
          ...
          >
            <Button 
              variant="contained" 
              color="error" 
              onClick={() => rejectCall(notification.user!)}
            ...
            <Button 
              variant="contained" 
              color="primary" 
              onClick={() => acceptCall(notification.user!)}
              startIcon={<CallIcon />}
              sx={{
                borderRadius: 2,
                px: 4,
